...
## Corpus Check
- 207 files · ~276,789 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1408 nodes · 2592 edges · 174 communities (82 shown, 92 thin omitted)
...
- `checkHasContent()` --references--> `react`  [EXTRACTED]
  client/src/lib/thread-hooks.ts → package.json

## Import Cycles
- None detected.

## Communities (174 total, 92 thin omitted)

### Community 0 - "message-thread-full.tsx"
Cohesion: 0.06
Nodes (55): GenerationStageProps, MessageGenerationStage(), MessageInput, MessageInputError(), MessageInputProps, MessageInputSubmitButton(), MessageInputTextarea(), MessageInputToolbar() (+47 more)

### Community 1 - "card.tsx"
Cohesion: 0.12
Nodes (15): GET_DATABASE_METRICS, toJsonSchema(), allTools, formatSkywalkingTime(), getDatabaseInsightsTool, getDatabasesTool, getDynamicDuration(), getEndpointsTool (+7 more)

### Community 2 - "tambo-tools.ts"
Cohesion: 0.30
Nodes (7): GET_LINEAR_INT_VALUES, GET_SERVICE_METRICS, METRICS, GET_SERVICE_ENDPOINTS, GET_SERVICE_INSTANCES, ServiceRef, SlowEndpointRow
...
### Community 4 - "cn"
Cohesion: 0.10
Nodes (33): PodCard(), ResizableHandle(), ResizablePanelGroup(), Separator, SheetHeader(), Sidebar(), SidebarContent(), SidebarContext (+25 more)
...
Cohesion: 0.08
Nodes (17): ThreadDropdown, ThreadDropdownProps, Avatar, AvatarFallback, AvatarImage, HoverCardContent, Progress, RadioGroup (+9 more)
...
Cohesion: 0.23
Nodes (10): DrawerContent(), Badge(), BadgeProps, badgeVariants, TabsContent, TabsList, TabsTrigger, useServiceMetrics() (+2 more)

### Community 12 - "useDurationStore"
Cohesion: 0.17
Nodes (15): AddStorageBackendDialog(), Props, DialogContent, DialogDescription, DialogFooter(), DialogHeader(), DialogOverlay, DialogTitle (+7 more)

### Community 13 - "dependencies"
Cohesion: 0.11
Nodes (19): class-variance-authority, clsx, framer-motion, dependencies, class-variance-authority, clsx, framer-motion, @prisma/client (+11 more)
...
Cohesion: 0.25
Nodes (11): ServiceOverviewCard(), ServiceOverviewCardProps, useServiceOverview(), apdexLabel(), extractPercentileMs(), formatApdexScore(), MetricPoint, parseExtendedMetrics() (+3 more)
...
Cohesion: 0.11
Nodes (23): DatabaseListCard(), DBInsightsCard(), DetailedMetricsCard(), Props, Props, ServiceInstancesCard(), ServiceListCard(), resolveDisplayStatus() (+15 more)

### Community 25 - "dropdown-menu.tsx"
Cohesion: 0.11
Nodes (22): autoRefreshOptions, DurationSelector(), ranges, OPTIONS, ThemeToggle(), DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuItem (+14 more)
...
Cohesion: 0.07
Nodes (53): GET_ALL_DATABASES, GET_TRACE_DETAILS, GET_TRACES_FOR_DB, GET_GLOBAL_TOPOLOGY, GET_SERVICE_TOPOLOGY, GET_TOPOLOGY, MetricChart(), CallingServicesPanel() (+45 more)

### Community 30 - "table.tsx"
Cohesion: 0.13
Nodes (15): GET_ALL_SERVICES, FailedTracesPanel(), formatTraceTime(), RankBadge(), rankStyles, ServiceRef, SlowEndpointsLeaderboard(), useSlowEndpoints() (+7 more)
...
Cohesion: 0.12
Nodes (16): FOOTER_LINKS, PublicLayout(), PublicLayoutProps, EndpointsListCard(), AccordionContent, AccordionItem, AccordionTrigger, Button (+8 more)
...
Cohesion: 0.07
Nodes (50): GET_TRACE_DETAILS, GET_TRACES, CriticalPathBanner(), CriticalPathBannerProps, ErrorFingerprintPanel(), ErrorFingerprintPanelProps, FlameGraph(), FlameGraphProps (+42 more)

### Community 47 - "clsx"
Cohesion: 0.14
Nodes (14): GET_K8S_NODES, GET_SERVICE_INSTANCES, K8sSetupPanel(), K8sSetupPanelProps, SETUP_STEPS, formatBytes(), getMQEValue(), K8sNodeExplorerPage() (+6 more)
...
Cohesion: 0.11
Nodes (16): client, httpLink, AppShell(), AuthenticatedApp(), isPublicPath(), AuthContext, AuthContextValue, AuthProvider() (+8 more)
...
Cohesion: 0.19
Nodes (12): getTopologyNodeColors(), ServiceRef, TopologyHealthEntry, useTopologyHealth(), resolveServiceHealth(), ServiceHealthStatus, ServiceNormalStatus, formatNodeLabel() (+4 more)
...
### Community 148 - "CustomRangePicker.tsx"
Cohesion: 0.33
Nodes (5): CustomRangePicker(), AppLayout(), AppLayoutProps, TAMBO_SYSTEM_PROMPT, PopoverContent
...
Cohesion: 0.17
Nodes (13): CodeHeader(), createMarkdownComponents(), looksLikeCode(), useCarousel(), SidebarProvider(), useIsMobile(), CodeHeader(), createMarkdownComponents() (+5 more)

### Community 161 - "generate-slide.py"
Cohesion: 0.11
Nodes (21): GET_EVENTS, GET_INSTANCE_DETAIL, GET_K8S_DASHBOARD, GET_MQE_METRICS, GET_NODE_INSTANCES, GET_NODE_METRICS, K8sPodEventsPanel(), K8sPodEventsPanelProps (+13 more)
...
## Knowledge Gaps
- **604 isolated node(s):** `httpLink`, `GET_NODE_METRICS`, `GET_NODE_INSTANCES`, `GET_TOPOLOGY`, `GET_SERVICE_TOPOLOGY` (+599 more)
...
- **Why does `cn()` connect `cn` to `message-thread-full.tsx`, `use-toast.ts`, `AppLayout.tsx`, `utils.ts`, `K8sNamespaceDetailPage.tsx`, `useDurationStore`, `menubar.tsx`, `CustomRangePicker.tsx`, `button.tsx`, `SkyWalking OAP on Oracle Cloud (Always Free)`, `carousel.tsx`, `dropdown-menu.tsx`, `TracesPage.tsx`, `context-menu.tsx`, `Workflow`, `useDurationStore.ts`, `table.tsx`, `breadcrumb.tsx`, `drawer.tsx`, `generate-slide.py`, `toggle-group.tsx`, `alert.tsx`, `accordion.tsx`, `avatar.tsx`, `class-variance-authority`, `clsx`, `date-fns`, `dotenv`, `framer-motion`, `useSidebar`, `@radix-ui/react-aspect-ratio`, `@tanstack/react-query`, `tw-animate-css`, `react-icons`?**
  _High betweenness centrality (0.227) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `@types/express`, `@types/node`, `K8sResourceDrawer.tsx`, `TestStyleTaxonomy`, `class-variance-authority`, `class-variance-authority`, `scripts/core.py`, `package.json`, `alert.tsx`, `react-icons`, `Workflow`, `alert-dialog.tsx`, `@tanstack/react-query`, `cmdk`, `connect-pg-simple`, `Design Principles`, `icon/generate.py`, `embla-carousel-react`, `express-session`, `fontSize`, `highlight.js`, `.add_components`, `TestShadcnInstaller`, `@jridgewell/trace-mapping`, `json-stringify-pretty-compact`, `CatalogRefreshTest`, `memorystore`, `graphql`, `passport-local`, `pg`, `radix-ui`, `@radix-ui/react-alert-dialog`, `@radix-ui/react-avatar`, `@radix-ui/react-checkbox`, `@radix-ui/react-collapsible`, `@radix-ui/react-dialog`, `@radix-ui/react-label`, `@radix-ui/react-menubar`, `@radix-ui/react-navigation-menu`, `@radix-ui/react-popover`, `@radix-ui/react-progress`, `@radix-ui/react-radio-group`, `@radix-ui/react-scroll-area`, `@radix-ui/react-select`, `@radix-ui/react-separator`, `@radix-ui/react-slider`, `@radix-ui/react-switch`, `@radix-ui/react-tabs`, `@radix-ui/react-toast`, `resizable.tsx`, `@radix-ui/react-toggle`, `react-dom`, `react-resizable-panels`, `react-xarrows`, `recharts`, `tailwind-merge`, `tailwindcss-animate`, `@tambo-ai/react`, `vaul`, `wouter`, `ws`, `zod`, `zod-validation-error`, `zustand`, `12`, `destructive`, `drizzle-orm`, `@radix-ui/react-slot`, `react-markdown`, `class-variance-authority`, `@types/connect-pg-simple`?**
  _High betweenness centrality (0.186) - this node is a cross-community bridge._
- **Why does `react` connect `Workflow` to `drawer.tsx`, `message-thread-full.tsx`, `cn`, `alert.tsx`, `use-toast.ts`, `K8sNamespaceDetailPage.tsx`, `dependencies`, `CustomRangePicker.tsx`, `SkyWalking OAP on Oracle Cloud (Always Free)`?**
